...
INSERT INTO `activityandaward` VALUES ('วันแรกพบนิสิตใหม่',2012,'0123456789','','5731017921','1100702284499'),('รางวัลดีเด่น',2012,'0123957912','ชนะเลิศ','5731013321','1579900647291'),('รางวัลดีเด่นมาก',2017,'0124813213','ชนะเลิศ','5731017921','1100702284499');
...
INSERT INTO `address` VALUES (0,'ทอง','หนทาง','เร็วมาก','เขวียง','ไม่ใช่ตำบล','ดีครับ',10990),(3,'','พระอาทิตย์','1','คลองต้นไทร','ภาษีเจริญ','กรุงเทพ',10256),(3,'','เยาวราช','','คลองต้นไทร','เมือง','กรุงเทพ',54810),(4,'','เพชรเกษม','98/1','บางแคเหนือ','บางแค','กรุงเทพ',10160),(7,'-','ราชพฤกษ์','-','สายสี่','ทวีวัฒนา','กรุงเทพ',10432),(11,'','ไอแพด','','ธนาคารโลก','นักเขียน','กระชับ',44440),(11,'','แคบมาก','','ฟาร์มเฮ้า','อินเทล','ชลบุรี',12345),(15,'สูตรเตี่ยว','เคม','','ปั่นงาน','เร็วดิ๊','เหนื่อยโว้ย',40040),(15,'กอขอคอ','แอปพรูฟ','','รีพอท','วิวคอส','แอดมิสชั่น',33030),(47,'','เลียบคลองสอง','6','บางชัน','คลองสามวา','กรุงเทพ',10510),(71,'','อุตรกิจ','','เวียง','เมืองเชียงราย','กรุงเทพ',57000),(80,'อาเงิน','นะจ๊ะ','โคตรถี่','ตำล่าง','ซีอุส','ไม่ดีครับ',11990),(156,'','นานาชาติ','','การผลิต','ภูมิภาค','สตรีม',66066),(156,'','แชร์','','ทวีต','อินสตาแกรม','ยูเฟลล์',61600),(192,'-','-','-','วังใหม่','ท่าใหม่','จันทบุรีี',22120);
...
INSERT INTO `consult` VALUES ('5391000232','1100234567891','5731013321','1579900647291'),('5731018911','1100702284488','5731017921','1100702284499');
...
INSERT INTO `instructor` VALUES ('5391000232','ปกติ','1100234567891'),('5731018911','ปกติ','1100702284488');
...
INSERT INTO `live_in` VALUES ('1100234567891','3','คลองต้นไทร','ภาษีเจริญ','กรุงเทพ'),('1100702284409','0','เขวียง','ไม่ใช่ตำบล','ดีครับ'),('1100702284415','11','ฟาร์มเฮ้า','อินเทล','ชลบุรี'),('1100702284422','11','ธนาคารโลก','นักเขียน','กระชับ'),('1100702284433','15','รีพอท','วิวคอส','แอดมิสชั่น'),('1100702284444','15','ปั่นงาน','เร็วดิ๊','เหนื่อยโว้ย'),('1100702284461','156','ทวีต','อินสตาแกรม','ยูเฟลล์'),('1100702284466','156','การผลิต','ภูมิภาค','สตรีม'),('1100702284499','4','บางแคเหนือ','บางแค','กรุงเทพ'),('1103456349766','47/294','บางชัน','คลองสามวา','กรุงเทพ'),('1220400156845','192','วังใหม่','ท่าใหม่','จันทบุรีี'),('1232091124576','7','สายสี่','ทวีวัฒนา','กรุงเทพ'),('123456789012','4','บางแคเหนือ','บางแค','กรุงเทพ'),('1579900647291','71','เวียง','เมืองเชียงราย','กรุงเทพ'),('1723020345719','3','คลองต้นไทร','เมือง','กรุงเทพ');
...
INSERT INTO `person` VALUES ('กิตติพงษ์','พูลขำ','ไทย','ชาย','1100234567891','Kittipong','Phoonkhum','0916458273','-','1978-03-31'),('โฮม','สตูเด้น','ไทย','ชาย','1100702284409','Home','Student','0910095150','homestu@local.com','1998-05-05'),('เฟส','บุ้ค','ไทย','หญิง','1100702284415','Face','Book','0910095151','facebook','1996-11-11'),('คอส','เคอริคูลัม','ไทย','ชาย','1100702284422','Cos','Curriculum','0910095155','costansin@hotmail.com','1997-02-02'),('แอ๊ด','ของดี','ไทย','ชาย','1100702284433','Add','khongdee','0910095133','addkhongdee@hotmail.com','1997-03-03'),('ตรี','โท','ไทย','ชาย','1100702284444','Tee','To','0910095144','teetoaek@hotmail.com','1994-04-04'),('โอ','เลี้ยง','ไทย','หญิง','1100702284461','Owl','Luang','0910095262','oluang@amail.com','1990-01-06'),('นิว','เคลียร์','ไทย','หญิง','1100702284466','New','Clear','0910095166','newclear@icemail.com','1994-06-06'),('จิรันตน์','พุ่มกุมาร','ไทย','ชาย','1100702284488','Jirun','Pumkuman','0816550800','ampol.pong@gmail.com','1967-01-31'),('จิรัฏฐ์','โพธิ์โลหะกุล','ไทย','ชาย','1100702284499','Jirut','Polohakul','0910095150','jirut.pol@gmail.com','1996-03-03'),('เกรียงศักดิ์','หทัยเกษมสุข','ไทย','ชาย','1103456349766','Kraingsak','Hathaikasemsuk','091091190','0Protocal0@gmail.com','1996-01-04'),('กานต์กวี','ชนะสิทธิ์','ไทย','ชาย','1220400156845','Kankawee','Chanasit','0841094759','krawan511@gmail.com','1995-08-19'),('สิน','มานิตพิสิตกุล','ไทย','ชาย','1232091124576','Sinn','Manitpisitkul','0813214755','-','1995-01-01'),('เขียว','แดง','ไทย','ชาย','123456789012','keaw','red','0859214544','keaw@gmail.com','1998-07-05'),('คณิติน','จันทร์ประเสริฐ','ไทย','ชาย','1579900647291','Khanitin','Chanprasert','0804943878','khanitin@hotmail.com','1996-02-02'),('ไกรภพ','ฟ้าส่งมา','ไทย','ชาย','1723020345719','Kraipob','Fasongma','0921394859','-','1999-02-02');
...
INSERT INTO `stay_in` VALUES ('1','1100234567891'),('1','1100702284499'),('1','1103456349766'),('1','1220400156845'),('1','1232091124576'),('1','123456789012'),('1','1579900647291'),('1','1723020345719'),('104','1100702284433'),('142','1100702284422'),('22','1100702284466'),('44','1100702284409'),('61','1100702284461'),('62','1100702284415'),('8','1100702284444');
...
INSERT INTO `student` VALUES ('5230088724','จบการศึกษา',2009,100,'1100702284461'),('5610923421','ปกติ',2013,100,'1232091124576'),('5630088721','ปกติ',2013,99,'1100702284444'),('5630088722','ปกติ',2013,99,'1100702284466'),('5730088726','ปกติ',2014,95,'1100702284433'),('5730345121','ปกติ',2015,50,'123456789012'),('5731007621','ปกติ',2014,100,'1220400156845'),('5731009921','ปกติ',2014,1000000,'1103456349766'),('5731013321','ปกติ',2014,95,'1579900647291'),('5731017921','ปกติ',2014,100,'1100702284499'),('5839988728','ปกติ',2015,97,'1100702284422'),('5845555524','ปกติ',2015,100,'1100702284415'),('5930102721','ปกติ',2016,100,'1723020345719'),('5930909923','ปกติ',2016,88,'1100702284409');
...
INSERT INTO `study_in` VALUES ('1','5610923421'),('1','5730345121'),('1','5731007621'),('1','5731013321'),('1','5731017921'),('1','5930102721');
...
INSERT INTO `take` VALUES (2014,'เทอมต้น',2,'5730345121','123456789012',1,'2301107'),(2014,'เทอมต้น',1,'5730345121','123456789012',1,'2302163'),(2014,'เทอมต้น',4,'5731007621','1220400156845',1,'2301107'),(2014,'เทอมต้น',3.5,'5731007621','1220400156845',1,'2302163'),(2014,'เทอมต้น',4,'5731007621','1220400156845',1,'2304107'),(2014,'เทอมต้น',3.5,'5731013321','1579900647291',1,'2301107'),(2014,'เทอมต้น',2.5,'5731017921','1100702284499',1,'2301107'),(2014,'เทอมปลาย',2.5,'5731017921','1100702284499',1,'2301108'),(2014,'เทอมต้น',2.5,'5731017921','1100702284499',1,'2302127'),(2014,'เทอมต้น',0,'5731017921','1100702284499',1,'2302163'),(2016,'เทอมต้น',4,'5731017921','1100702284499',33,'2110200'),(2016,'เทอมต้น',4,'5930102721','1723020345719',1,'2301107');
...
-- Dump completed on 2017-04-30 21:41:29
